...
user6 =User.create!(username: 'beauty', display_name: 'Beauty', email: 'nope@fakeemail.com', password: 'ibeast')
user7 =User.create!(username: 'beast', display_name: 'Beast', email: 'yep@fakeemail.com', password: 'ibeauty')
